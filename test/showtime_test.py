...
class TestShowTimeService(unittest.TestCase):
    def setUp(self):
        self.url = "http://127.0.0.1:5002/showtime"

    def test_showtime_records(self):
        """ Test /showtime/<date> for all known showtimes"""
        for date, expected in GOOD_RESPONSES.iteritems():
            ...
            self.assertEqual(len(actual_reply), len(expected),
                             "Got {} showtime but expected {}".format(
    ...
    def test_not_found(self):
        """ Test /showtime/<date> for non-existent dates"""
